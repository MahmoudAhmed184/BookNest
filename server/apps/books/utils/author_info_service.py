...
class AuthorInfoService:
    ...
    def get_author_info(author_name: str) -> dict[str, Any]:
        ...
        try:
            ...
            results = {"name": author_name, "bio": "", "birth_date": None, "number_of_books": 0}
    ...
    def _get_wikipedia_info(author_name: str) -> dict[str, Any]:
        ...
        try:
            ...
            search_params = {"action": "query", "list": "search", "srsearch": author_name, "format": "json"}
    ...
    def _get_wikidata_info(author_name: str) -> dict[str, Any]:
        ...
        try:
            ...
            # Get the entity data
            entity_params = {"action": "wbgetentities", "ids": entity_id, "languages": "en", "format": "json"}
    ...
    @staticmethod
    def _get_claim_value(claims: dict[str, Any], property_id: str) -> str | None:
    ...
    def _get_goodreads_info(author_name: str) -> dict[str, Any]:
        ...
        try:
            # First, search for the author
            search_url = (
                f"{AuthorInfoService.GOODREADS_API_URL}?key={settings.GOODREADS_API_KEY}&name={quote(author_name)}"
            )
