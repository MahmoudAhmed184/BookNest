...
from apps.books.models import BookReview, ReviewUpvote
from apps.books.serializers.review_serializers import ReviewUpvoteSerializer, BookReviewSerializer
