...
from apps.books.views.views import (
    BookListAPIView,
    BookDetailAPIView,
    AuthorListAPIView,
    AuthorDetailAPIView,
...
from apps.books.views.search_views import BookSearchAPIView
from apps.books.views.suggestion_views import BookSuggestionAPIView

from apps.books.views.review_views import (
    BookReviewAPIView,
...
from apps.books.views.upvote_views import (
...
from apps.books.views.vote_views import (
...
from apps.books.views.reading_list_views import (
    ReadingListAPIView,
