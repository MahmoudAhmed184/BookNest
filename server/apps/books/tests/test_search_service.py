...
class BookSearchServiceTests(TestCase):
    ...
    def test_search_index_contains_weighted_book_metadata(self):
    ...
    def test_search_books_returns_local_full_text_matches(self):
    ...
    def test_no_local_results_queue_external_enrichment_without_waiting(self):
        with patch.object(
