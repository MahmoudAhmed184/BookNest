    ...
    <div className="py-12 flex flex-col gap-10 animate-fade-up" role="status" aria-live="polite">
      <div className="flex flex-col items-center gap-6 md:flex-row md:items-end">
        ...
        <div className="flex grow flex-col gap-4">
          ...
          <div className="h-11 w-32 rounded-xl animate-shimmer" />
        </div>
      </div>
...
export default function UserProfile() {
  ...
  return (
    <div className="flex flex-col gap-12 py-12 animate-fade-up">
      ...
      <section className="grid gap-4 sm:grid-cols-3" aria-label="Reading stats">
        <div className="rounded-xl bg-secondary-black p-5">
          <p className="text-3xl font-bold text-primary-white">
            {books.length || primaryCollection?.book_count || 0}
          </p>
      ...
      <section className="flex flex-col gap-5" aria-labelledby="user-books-title">
        <div className="flex flex-wrap items-end justify-between gap-3">
          <h2 id="user-books-title" className="text-xl font-semibold text-primary-white sm:text-2xl">
            Books
          </h2>
        ...
        {books.length === 0 ? (
          <EmptyState
            ...
            description="This reader's shelf is empty for now."
          ...
          <Swiper
            ...
            slidesPerView={1}
            navigation={{
              prevEl: ".user-books-prev",
              nextEl: ".user-books-next",
            }}
          ...
          >
            ...
            <div className="swiper-button-prev user-books-prev"></div>
            <div className="swiper-button-next user-books-next"></div>
          </Swiper>
        )}
      </section>
      ...
      <section className="flex flex-col gap-5" aria-labelledby="reviews-title">
        <div className="flex flex-wrap items-end justify-between gap-3">
          <h2 id="reviews-title" className="text-xl font-semibold text-primary-white sm:text-2xl">
            Reviews
          </h2>
        ...
        {isReviewsError || isRatingsError ? (
          <ErrorState
            ...
            message="We could not load this reader's reviews right now."
            onRetry={() => {
              void refetchReviews();
              void refetchRatings();
            }}
        ...
        (reviews?.length ?? 0) === 0 ? (
          <EmptyState
            ...
            description="This reader has not shared any reviews yet."
          />
        ) : null}
        {!isReviewsLoading &&
        !isReviewsError &&
              ...
              <div className="flex grow flex-col gap-3">
                <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
                  ...
                  <p
                    ...
                    aria-label={`Reader rating ${ratings?.[index]?.rate ?? 0} out of 5`}
                  >
                    {[1, 2, 3, 4, 5].map((star) => (
                      <span
                        key={star}
                ...
                {review.created_at ? (
                  <p className="mt-auto text-xs text-primary-gray">
                    {review.created_at}
                  </p>
                ) : null}
              </div>
